...
apt-get install -y x11vnc net-tools sysstat fvwm
...
(crontab -u vagrant -l ; echo '@reboot sar -o /var/log/sar_cpu.log 1 > /dev/null 2>&1') | crontab -u vagrant -
(crontab -u vagrant -l ; echo '@reboot sar -o /var/log/sar_mem.log -r 1 > /dev/null 2>&1') | crontab -u vagrant -
